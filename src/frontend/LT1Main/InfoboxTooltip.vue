...
<template>
    <div>
        ...
        <svg v-if="tooltip" v-tooltip="{ content: tooltip }" class="infobox-tooltip" version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 46 46" xml:space="preserve" >
            <g>
